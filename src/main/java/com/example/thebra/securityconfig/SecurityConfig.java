...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .permitAll()
                .requestMatchers(HttpMethod.GET, "api/v1/orderItems/{orderId}")
                .permitAll()
                .requestMatchers(HttpMethod.GET, "/api/v1/order/")
                .permitAll()
                .requestMatchers(HttpMethod.POST, "/api/v1/email/client")
                .permitAll()
                .requestMatchers(HttpMethod.POST, "/api/v1/order/")
                .authenticated()
                .requestMatchers(HttpMethod.GET, "/api/v1/order/myOrders")
                .authenticated()
