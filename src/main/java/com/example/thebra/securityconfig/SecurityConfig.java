...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .requestMatchers("/api/v1/customers/signin", "/api/v1/customers/signup", "/api/v1/customers/","api/v1/products/","api/v1/products/{id}","api/v1/products/updateProductSize", "/api/v1/order/{id}","api/v1/stripe/processpayment","api/v1/stripe/charge")
                .permitAll()
